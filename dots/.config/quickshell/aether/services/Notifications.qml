...
Singleton {
  id: root
  readonly property bool soundEnabled: Config.options.sounds.notifications ?? false
  ...
  NotificationServer {
    ...
    onNotification: notification => {
      ...
      if (root.soundEnabled && notification.appName !== "System Notifications") Audio.playSystemSound("message");
