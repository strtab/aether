...
Singleton {
  ...
  function playSystemSound(soundName) {
    const ogaPath = `/run/current-system/sw/share/sounds/${root.audioTheme}/stereo/${soundName}.oga`;
    const oggPath = `/run/current-system/sw/share/sounds/${root.audioTheme}/stereo/${soundName}.ogg`;
