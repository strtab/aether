  ...
  GridLayout {
    ...
    RippleButton {
      ...
      contentItem: MaterialSymbol {
        ...
        color: !Config.options.bar.background.enable ? Appearance.colors.onMenubarBackground : root.trayOverflowOpen ? Appearance.colors.colOnSecondaryContainer : Appearance.colors.colOnLayer2
