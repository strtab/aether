...
Item {
  ...
  property point offset: Qt.point((canvas.width - bounds.width * scaleFactor) / 2 - bounds.minX * scaleFactor, (canvas.height - bounds.height * scaleFactor) / 2 - bounds.minY * scaleFactor)
