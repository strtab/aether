...
Item {
  ...
  Popup {
    ...
    background: Rectangle {
      color: Appearance.inirEverywhere ? Appearance.inir.colLayer2 : Appearance.colors.colLayer2Base
    ...
    ColumnLayout {
      ...
      ListView {
        ...
        delegate: RippleButton {
          ...
          colBackground: modelData === root.selectedFont ? Appearance.colors.colPrimaryContainer : "transparent"
          colBackgroundHover: Appearance.colors.colLayer1Hover
          colRipple: Appearance.colors.colLayer1Active
          ...
          contentItem: StyledText {
            ...
            font.pixelSize: Appearance.font.pixelSize.small
            elide: Text.ElideRight
            color: modelData === root.selectedFont ? Appearance.m3colors.m3onPrimaryContainer : Appearance.m3colors.m3onSurface
          }
