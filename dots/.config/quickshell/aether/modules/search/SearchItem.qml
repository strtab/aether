...
RippleButton {
  ...
  RowLayout {
    id: rowLayout
    spacing: iconLoader.sourceComponent === null ? 0 : (10 + (Config.options.search.fontSize / 3))
    anchors.fill: parent
    ...
    Component {
      ...
      IconImage {
        ...
        width: 35 + (Config.options.search.fontSize / 6)
        height: 35 + (Config.options.search.fontSize / 6)
      }
    }
    ...
    Component {
      ...
      StyledText {
        text: root.bigText
        font.pixelSize: (Config.options.search.fontSize + 2) ?? Appearance.font.pixelSize.larger
        color: Appearance.m3colors.m3onSurface
      }
    }
    ...
    ColumnLayout {
      ...
      spacing: 0
      // StyledText {
      //   font.pixelSize: (Config.options.search.fontSize - 5) ?? Appearance.font.pixelSize.smaller
      ...
      RowLayout {
        Loader { // Checkmark for copied clipboard entry
          ...
          sourceComponent: Rectangle {
            ...
            MaterialSymbol {
              ...
              text: "check"
              font.pixelSize: (Config.options.search.fontSize - 4) ?? Appearance.font.pixelSize.normal
        ...
        ColumnLayout {
          ...
          StyledText { // Item name/content
            ...
            font.pixelSize: (Config.options.search.fontSize - 4) ?? Appearance.font.pixelSize.small
          ...
          StyledText { // Item comment
            ...
            font.pixelSize: (Config.options.search.fontSize - 6) ?? Appearance.font.pixelSize.smaller
            color: Appearance.colors.colSubtext
            elide: Text.ElideRight
